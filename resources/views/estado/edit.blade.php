...
@section('content')
    ...
    <div class="mb-3">
        ...
        <input id="id" name="id" type="text" class="form-control" tabindex="1" value="{{$estado->id}}" autofocus>
        @if ($errors->has('id'))
    ...
    <div class="mb-3">
        ...
        <input id="estado" name="estado" type="tel" class="form-control" tabindex="2" value="{{$estado->estado}}" autofocus>
